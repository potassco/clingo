...
static int _cffi_const_clingo_backend_type_reify(unsigned long long *o)
{
  int n = (clingo_backend_type_reify) <= 0;
  *o = (unsigned long long)((clingo_backend_type_reify) | 0);  /* check that clingo_backend_type_reify is an integer */
  return n;
}

static int _cffi_const_clingo_backend_type_reify_sccs(unsigned long long *o)
{
  int n = (clingo_backend_type_reify_sccs) <= 0;
  *o = (unsigned long long)((clingo_backend_type_reify_sccs) | 0);  /* check that clingo_backend_type_reify_sccs is an integer */
  return n;
}

static int _cffi_const_clingo_backend_type_reify_steps(unsigned long long *o)
{
  int n = (clingo_backend_type_reify_steps) <= 0;
  *o = (unsigned long long)((clingo_backend_type_reify_steps) | 0);  /* check that clingo_backend_type_reify_steps is an integer */
  return n;
}

static int _cffi_const_clingo_backend_type_aspif(unsigned long long *o)
{
  int n = (clingo_backend_type_aspif) <= 0;
  *o = (unsigned long long)((clingo_backend_type_aspif) | 0);  /* check that clingo_backend_type_aspif is an integer */
  return n;
}

static int _cffi_const_clingo_backend_type_smodels(unsigned long long *o)
{
  int n = (clingo_backend_type_smodels) <= 0;
  *o = (unsigned long long)((clingo_backend_type_smodels) | 0);  /* check that clingo_backend_type_smodels is an integer */
  return n;
}
...
static _Bool _cffi_d_clingo_control_register_backend(clingo_control_t * x0, unsigned int x1, char const * x2, _Bool x3)
{
  return clingo_control_register_backend(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_clingo_control_register_backend(PyObject *self, PyObject *args)
{
  clingo_control_t * x0;
  unsigned int x1;
  char const * x2;
  ...
  if (!PyArg_UnpackTuple(args, "clingo_control_register_backend", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = clingo_control_register_backend(x0, x1, x2, x3); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_clingo_control_register_backend _cffi_d_clingo_control_register_backend
#endif
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "clingo_backend_type_aspif", (void *)_cffi_const_clingo_backend_type_aspif, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
  { "clingo_backend_type_reify", (void *)_cffi_const_clingo_backend_type_reify, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
  { "clingo_backend_type_reify_sccs", (void *)_cffi_const_clingo_backend_type_reify_sccs, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
  { "clingo_backend_type_reify_steps", (void *)_cffi_const_clingo_backend_type_reify_steps, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
  { "clingo_backend_type_smodels", (void *)_cffi_const_clingo_backend_type_smodels, _CFFI_OP(_CFFI_OP_ENUM, -1), (void *)0 },
