...
//!
//! Such an iterator either pseoints to a symbolic atom within a sequence of
...
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_size(clingo_base_t const *atoms, size_t *size);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_begin(clingo_base_t const *atoms,
...
//! @param[out] iterator the resulting iterator
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_end(clingo_base_t const *atoms,
                                                          clingo_symbolic_atom_iterator_t *iterator);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_find(clingo_base_t const *atoms, clingo_symbol_t symbol,
                                                           clingo_symbolic_atom_iterator_t *iterator);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_iterator_is_equal_to(clingo_base_t const *atoms,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_symbol(clingo_base_t const *atoms,
                                                             clingo_symbolic_atom_iterator_t iterator,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_is_fact(clingo_base_t const *atoms,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_is_external(clingo_base_t const *atoms,
                                                                  clingo_symbolic_atom_iterator_t iterator,
                                                                  bool *external);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_literal(clingo_base_t const *atoms,
                                                              clingo_symbolic_atom_iterator_t iterator,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_signatures_size(clingo_base_t const *atoms, size_t *size);
...
//! @return the result code
//!
//! @see clingo_base_signatures_size()
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_signatures(clingo_base_t const *atoms,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_next(clingo_base_t const *atoms,
                                                           clingo_symbolic_atom_iterator_t iterator,
...
//! sequence
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_base_is_valid(clingo_base_t const *atoms,
