...
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_decision_level(clingo_assignment_t const *assignment,
                                                                           uint32_t *level);
...
//! @param[out] level the decision level
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_root_level(clingo_assignment_t const *assignment,
                                                                       uint32_t *level);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_has_conflict(clingo_assignment_t const *assignment,
                                                                         bool *is_conflicting);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_has_literal(clingo_assignment_t const *assignment,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_level(clingo_assignment_t const *assignment,
                                                                  clingo_literal_t literal, uint32_t *level);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_decision(clingo_assignment_t const *assignment,
                                                                     uint32_t level, clingo_literal_t *literal);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_is_fixed(clingo_assignment_t const *assignment,
...
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_is_true(clingo_assignment_t const *assignment,
...
//! @return the result code
//! @see clingo_assignment_truth_value()
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_is_false(clingo_assignment_t const *assignment,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_truth_value(clingo_assignment_t const *assignment,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_size(clingo_assignment_t const *assignment, size_t *size);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_at(clingo_assignment_t const *assignment, size_t offset,
                                                               clingo_literal_t *literal);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_is_total(clingo_assignment_t const *assignment,
                                                                     bool *is_total);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_trail_size(clingo_assignment_t const *assignment,
                                                                       uint32_t *size);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_trail_begin(clingo_assignment_t const *assignment,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_trail_end(clingo_assignment_t const *assignment,
                                                                      uint32_t level, uint32_t *offset);
...
//! @param[out] literal the literal
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_assignment_trail_at(clingo_assignment_t const *assignment,
                                                                     uint32_t offset, clingo_literal_t *literal);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_solver_literal(clingo_propagate_init_t const *init,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_add_watch(clingo_propagate_init_t *init,
                                                                          clingo_literal_t solver_literal);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_add_watch_to_thread(clingo_propagate_init_t *init,
                                                                                    clingo_literal_t solver_literal,
...
//! @param[in] solver_literal the solver literal
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_remove_watch(clingo_propagate_init_t *init,
                                                                             clingo_literal_t solver_literal);
...
//! @param[in] thread_id the id of the solver thread
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_remove_watch_from_thread(
    clingo_propagate_init_t *init, clingo_literal_t solver_literal, uint32_t thread_id);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_base(clingo_propagate_init_t const *init,
...
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_set_check_mode(clingo_propagate_init_t *init,
...
//! @return the result code
//! @see @ref ::clingo_propagator::check()
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_set_undo_mode(clingo_propagate_init_t *init,
...
//! @param[out] result result indicating whether the problem became unsatisfiable
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_init_propagate(clingo_propagate_init_t *init, bool *result);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_control_add_literal(clingo_propagate_control_t *control,
...
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_control_add_watch(clingo_propagate_control_t *control,
                                                                             clingo_literal_t literal);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_control_has_watch(clingo_propagate_control_t const *control,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_control_remove_watch(clingo_propagate_control_t *control,
                                                                                clingo_literal_t literal);
//! Add the given clause to the solver.
//!
...
//! @param[out] result result indicating whether propagation has to be stopped
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_propagate_control_propagate(clingo_propagate_control_t *control,
                                                                             bool *result);

//! @}

//! Typedef for @ref ::clingo_propagator::init().
typedef clingo_result_t (*clingo_propagator_init_callback_t)(clingo_propagate_init_t *, void *);

//! Typedef for @ref ::clingo_propagator::propagate().
typedef clingo_result_t (*clingo_propagator_propagate_callback_t)(clingo_propagate_control_t *,
...
typedef clingo_result_t (*clingo_propagator_check_callback_t)(clingo_propagate_control_t *, void *);
...
typedef struct clingo_propagator {
    ...
    clingo_result_t (*init)(clingo_propagate_init_t *init, void *data);
    ...
    clingo_result_t (*propagate)(clingo_propagate_control_t *control, clingo_literal_t const *changes, size_t size,
                                 void *data);
    ...
    clingo_result_t (*check)(clingo_propagate_control_t *control, void *data);
    ...
    //! @return the result code
    clingo_result_t (*decide)(clingo_id_t thread_id, clingo_assignment_t const *assignment, clingo_literal_t fallback,
