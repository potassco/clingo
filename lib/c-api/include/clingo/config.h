...
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_config_root(clingo_config_t const *config, clingo_id_t *key);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_config_type(clingo_config_t const *config, clingo_id_t key,
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_config_array_size(clingo_config_t const *config, clingo_id_t key,
                                                                   size_t *size);
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_config_array_at(clingo_config_t const *config, clingo_id_t key,
                                                                 size_t offset, clingo_id_t *subkey);
//! @}
...
//! @return the result code
CLINGO_VISIBILITY_DEFAULT clingo_result_t clingo_config_map_size(clingo_config_t const *config, clingo_id_t key,
                                                                 size_t *size);
