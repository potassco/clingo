...
class Observer:
    ...
    def output_csp(self, symbol: Symbol, value: int, condition: List[int]) -> None: ...
    def external(self, atom: int, value: TruthValue) -> None: ...
    def assume(self, literals: List[int]) -> None: ...
    def heuristic(self, atom: int, type: HeuristicType, bias: int, priority: int, condition: List[int]) -> None: ...
    def acyc_edge(self, node_u: int, node_v: int, condition: List[int]) -> None: ...
    def theory_term_number(self, term_id: int, number: int) -> None: ...
    def theory_term_string(self, term_id : int, name : str) -> None: ...
    def theory_term_compound(self, term_id: int, name_id_or_type: int, arguments: List[int]) -> None: ...
    def theory_element(self, element_id: int, terms: List[int], condition: List[int]) -> None: ...
    def theory_atom(self, atom_id_or_zero: int, term_id: int, elements: List[int]) -> None: ...
    def theory_atom_with_guard(self, atom_id_or_zero: int, term_id: int, elements: List[int], operator_id: int, right_hand_side_id: int) -> None: ...
