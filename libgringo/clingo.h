...
enum clingo_theory_atom_type {
    clingo_theory_atom_type_head,
    clingo_theory_atom_type_body,
    clingo_theory_atom_type_directive
};
typedef int clingo_theory_atom_type_t;
...
clingo_error_t clingo_theory_atoms_atom_type(clingo_theory_atoms_t *atoms, clingo_id_t, clingo_theory_atom_type_t *ret);
